...
<link rel="stylesheet" href="<?= \yii\helpers\Url::current(['/assets/admin/css/compiled/new-user.css']); ?>" type="text/css" media="screen"/>
<link rel="stylesheet" href="<?= \yii\helpers\Url::current(['/assets/admin/css/lib/bootstrap-wysihtml5.css']); ?>" type="text/css" media="screen"/>
<!-- main container -->
<div class="content">
                ...
                <div class="span9 with-sidebar">
                    <div class="container">
                        ...
                        foreach ((array)json_decode($model->pics, true) as $k => $pic) {
                            ?>
                            <img src="<?php echo $pic . '-covermiddle' ?>">
