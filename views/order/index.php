                        ...
                        <table style="width:100%;border-collapse:collapse;border-spacing:0px;">
                            ...
                            <tr style="background-color:#F5F5F5;width:100%">
                                <td style="padding:10px 20px;text-align:left;width:100%">
                                    <label><strong title="" style="margin-right:8px;font-weight:bold;"><?php echo date('Y-m-d H:i:s', $order['createtime']); ?></strong></label>
                                    <span>订单号：</span>
                                    <span></span>
                            ...
                            <tr>
                                <td style="text-align:left;vertical-align:top;padding-top:10px;padding-bottom:10px;border-right-width:0;border-right-style:solid;border-right-color:#E8E8E8;border-top-width:0;border-top-style:solid;border-top-color:#E8E8E8;padding-left:20px;">
                                    <div style="overflow:hidden;">
                                        <a class="tp-tag-a"
                                           href="<?php echo yii\helpers\Url::to(['product/detail', 'productid' => $item['productid']]) ?>"
                                           style="float:left;width:27%;margin-right:2%;text-align:center;"
                                           target="_blank">
                                            <img src="<?php echo $item['cover'] ?>-coversmall" style="border:1px solid #E8E8E8;max-width:80px;">
                                        </a>
                                        <div style="float:left;width:71%;word-wrap:break-word;">
                                            <div style="margin:0px;">
                                                <a class="tp-tag-a"
                                                   href="<?php echo yii\helpers\Url::to(['product/detail', 'productid' => $item['productid']]) ?>"
                                                   target="_blank"><span><?php echo $item['title'] ?></span></a>
                                                <span></span>
                                            </div>
                                            <div style="margin-top:8px;margin-bottom:0;color:#9C9C9C;">
                                                <span style="margin-right:6px;"><span>分类</span><span>：</span><span><?php echo $item['category']['title'] ?></span></span>
                                            </div>
                                            <span></span>
                                        </div>
                                    </div>
                                ...
                                <td style="text-align:center;vertical-align:top;padding-top:10px;padding-bottom:10px;border-right-width:0;border-right-style:solid;border-right-color:#E8E8E8;border-top-width:0;border-top-style:solid;border-top-color:#E8E8E8;">
                                    <div>
                                        <div>
                                            数量 <?php echo $order['detail'][$k]['productnum'] ?>
                                        </div>
                                    </div>
                                </td>
                                        ...
                                        <span>
                                            <span class="trade-ajax">
                                                <span class="trade-tooltip-wrap">
                                                    <span>
                                                        <span class="trade-operate-text">单位：个</span>
                                                    </span>
                                                </span>
                                                <noscript></noscript>
                                            </span>
                                ...
                                <?php if ($i == 1): ?>
                                    <td style="text-align:center;vertical-align:top;padding-top:10px;padding-bottom:10px;border-right-width:1px;border-right-style:solid;border-right-color:#E8E8E8;border-top-width:0;border-top-style:solid;border-top-color:#E8E8E8;">
                                        <div>
                                            <div style="font-family:verdana;font-style:normal;"><span></span>
                                                <span></span>
                                                <p>
                                                    <strong>
                                            ...
                                            <p><span>(含运费：</span>
                                                <span><?php echo empty(\Yii::$app->params['expressPrice'][$order['expressid']]) ? '0' : \Yii::$app->params['expressPrice'][$order['expressid']] ?> 元</span>
                                                <span></span>
                                                <span></span>
                                                <span>)</span>
                                            </p>
                                    ...
                                    <td style="text-align:center;vertical-align:top;padding-top:10px;padding-bottom:10px;border-right-width:1px;border-right-style:solid;border-right-color:#E8E8E8;border-top-width:0;border-top-style:solid;border-top-color:#E8E8E8;" >
                                        <div style="margin-bottom:3px;">
                                            <a class="tp-tag-a" href="<?php echo yii\helpers\Url::to(['order/check', 'orderid' => $order['orderid']]) ?>"><?php echo $zhstatus[$order['status']] ?></a>
                                        </div>
                                            ...
                                            <div style="margin-bottom:3px;position:relative">
                                                <span>
                                                    <a class="tp-tag-a" href="<?php echo yii\helpers\Url::to(['order/received', 'orderid' => $order['orderid']]) ?>">
                                                        <span class="trade-operate-text">确认收货</span>
