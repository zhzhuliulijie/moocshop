...
<head>
    ...
    <!-- libraries -->
    <link href="<?= \yii\helpers\Url::to(['/assets/admin/css/lib/jquery-ui-1.10.2.custom.css']); ?>" rel="stylesheet"/>
    ...
    <link href="<?= \yii\helpers\Url::to(['/assets/admin/css/compiled/index.css']); ?>" rel="stylesheet"/>
            ...
            <li class="notification-dropdown hidden-phone">
                ...
                <div class="pop-dialog">
                    ...
                    <div class="body">
                        ...
                        <div class="messages">
                            <a href="#" class="item">
                                <img src="<?=\yii\helpers\Url::to(['/assets/admin/img/contact-img.png']);?>" class="display"/>
                            ...
                            <a href="#" class="item">
                                <img src="<?=\yii\helpers\Url::to(['/assets/admin/img/contact-img2.png']);?>" class="display"/>
                                <div class="name">Alejandra Galván</div>
                                <div class="msg">
...
<div id="sidebar-nav">
    <ul id="dashboard-menu">
        ...
        <li>
            ...
            <ul class="submenu">
                <li><a href="<?php echo \yii\helpers\Url::to(['category/list']); ?>">商品分类列表</a></li>
                <li><a href="<?php echo \yii\helpers\Url::to(['category/add']); ?>">添加商品分类</a></li>
            </ul>
        </li>
        <li>
            <a class="dropdown-toggle" href="#">
...
<script src="<?=\yii\helpers\Url::to(['/assets/admin/js/jquery-ui-1.10.2.custom.min.js']);?>"></script>
<!-- knob -->
<script src="<?=\yii\helpers\Url::to(['/assets/admin/js/jquery.knob.js']);?>"></script>
<!-- flot charts -->
<script src="<?=\yii\helpers\Url::to(['/assets/admin/js/jquery.flot.js']);?>"></script>
<script src="<?=\yii\helpers\Url::to(['/assets/admin/js/jquery.flot.stack.js']);?>"></script>
<script src="<?=\yii\helpers\Url::to(['/assets/admin/js/jquery.flot.resize.js']);?>"></script>
<script src="<?=\yii\helpers\Url::to(['/assets/admin/js/theme.js']);?>"></script>

<script src="<?=\yii\helpers\Url::to(['/assets/admin/js/wysihtml5-0.3.0.js']);?>"></script>
<script src="<?=\yii\helpers\Url::to(['/assets/admin/js/bootstrap-wysihtml5-0.0.2.js']);?>"></script>
