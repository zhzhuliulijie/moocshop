        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <section class="section sign-in inner-right-xs">
                    <h2 class="bordered">
                        <img src="<?= Yii::$app->session['userinfo']['figureurl_qq_1']; ?>" width="40" height="40" align="center" alt="">
                        绑定账号
                    </h2>
                    <p>请您输入一个账户名和密码</p>
                    <?php
                    ...
                    ?>
                    <div class="field-row"><input type="text" value="<?=Yii::$app->session['userinfo']['nickname']; ?>" class="le-input"></div>
